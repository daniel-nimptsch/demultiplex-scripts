...
# TODO: Add a validation step of input samplesheet: check for consistency in the barcode and primer names as well as thier sequences. For this move parse_novogene_samplesheet execution to here at the beginning: Pipe output of novogene samplesheet to validation script.
...
# TODO: Do not take INPUT_DIR. Just take a list of fastqs
# TODO: Fix creation of tsv, tab delimiter is not inserted correctly. Maybe use python for this and take optional ouput filename -o.
...
# TODO: Do not take INPUT_DIR. Just take a list of fastqs. Then we can just remove all validation in this script
# TODO: Fix creation of tsv, tab delimiter is not inserted correctly
...
# TODO: Think about how I could use the info file generated by cutadapt
...
# TODO: Implement script to generate track_reads.tsv with input fastq and sample fastq read counts. should be easy
