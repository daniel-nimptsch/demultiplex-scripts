...
def main():
    ...
    parser.add_argument(
        'fq_gz_1', 
        type=str, 
        help='Path to the first FASTQ file (R1)'
    )
    parser.add_argument(
        'fq_gz_2', 
        type=str, 
    ...
    with open(samplesheet, mode='r') as file:  # Open the samplesheet file
        ...
        forward_fasta = os.path.join(output_dir, f"barcodes_fwd.fasta")
        reverse_fasta = os.path.join(output_dir, f"barcodes_bc_rev.fasta")
