...
def save_patterns(barcodes, output_dir):
    ...
    with patterns_file.open("w") as file:
        for (
            ...
            pattern_1 = f"demux-{forward_barcode_name}_{reverse_barcode_name}.1.fastq.gz {sample_name}.1.fastq.gz"
            pattern_2 = f"demux-{forward_barcode_name}_{reverse_barcode_name}.2.fastq.gz {sample_name}.2.fastq.gz"
